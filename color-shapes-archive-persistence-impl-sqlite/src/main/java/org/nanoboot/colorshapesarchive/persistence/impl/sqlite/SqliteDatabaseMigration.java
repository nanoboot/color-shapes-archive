...
public class SqliteDatabaseMigration {
    ...
    public MigrationResult migrate() {
        ...
        String jdbcUrl= "jdbc:sqlite:" + System.getProperty("color-shapes-archive.confpath") + "/" + "color_shapes_archive.sqlite";
        System.err.println("jdbcUrl=" + jdbcUrl);
        String clazz = this.getClass().getName();
        DBMigration dbMigration = DBMigration
                .configure()
                .dataSource(jdbcUrl)
                .installedBy("color-shapes-archive-persistence-impl-sqlite")
                .name("colorshapesarchive")
