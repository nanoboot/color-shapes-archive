...
<html>
    <head>
        <title>Review of variants - Color Shapes Archive</title>
 ...
 <a href="review.jsp" class="nav_a_current">Review</a>       
    ...
    %>
        ...
        %>
                ...
                java.io.File file = new java.io.File(System.getProperty("color-shapes-archive.confpath") + "/" + "variantsScreenshots/" + v.getNumber() + ".jpg");
                if (file.exists()) {
