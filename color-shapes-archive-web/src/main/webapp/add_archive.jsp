...
<html>
    <head>
        <title>Add Archive - Color Shapes Archive</title>
...
boolean success = false;
        ...
        throw new jakarta.servlet.jsp.SkipPageException("Cannot upload archive. Reason: This property is not defined: color-shapes-archive.archiveDir");
        }
